...
namespace Supermarkt
{
    class Kunde : Person
    {
        ...
        public Kunde(string kundenID, string firstname, string lastname, int age, string address, int filiale) : base("K"+kundenID, firstname, lastname, age, address, filiale)
        {
            if (age < 14)
